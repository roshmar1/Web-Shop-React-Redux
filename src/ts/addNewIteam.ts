...
const addNewIteam = () => {    
  let name:string = (document.getElementById('ItemName') as HTMLInputElement).value ;
  let description:string =(document.getElementById('ItemDescrimption') as HTMLInputElement).value;
  let category:string =(document.getElementById('ItemCategory') as HTMLInputElement).value ;
  let selectedFile:any = (document.getElementById('ItemCategory') as HTMLInputElement).files;  
...
export {addNewIteam,loadOnce,addDataToStorage}
